...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "परिचय सेतु" },
      { name: "description", content: "सच्चे रिश्तों की खूबसूरत शुरुआत।" },
      { name: "author", content: "परिचय सेतु" },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Outlet />
      <footer className="border-t border-primary/20 bg-primary py-5 text-center text-ivory">
  <p className="px-4 text-xs text-ivory/85">
    Developement Partner —{" "}
    <span className="font-semibold text-marigold">
      KodeCrown Technologies Pvt Ltd
    </span>
  </p>

  <div className="mt-2 flex items-center justify-center gap-2 px-4 text-xs text-ivory/85">
    <a
    ...
    >
      ...
      <span>(+91) 97533 09166</span>
      {/* <span className="text-ivory/60">(WhatsApp only)</span> */}
    </a>
  </div>
</footer>
    </QueryClientProvider>
